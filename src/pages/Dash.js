...
import { faArrowRight, faBookmark, faHeart, faMinus } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className="dash">
            ...
            <div className="grid two">
                <div className="grid-profile">
                    ...
                    <h3 className="profile-name">Precious</h3>
                </div>
                    ...
                    <div className="single-post">
                        ...
                        <div className="single-post-details">
                            ...
                            <div className="post-icons">
                                <FontAwesomeIcon icon={faHeart} /><p >0</p>
                                <FontAwesomeIcon icon={faBookmark} /><p >0</p>
